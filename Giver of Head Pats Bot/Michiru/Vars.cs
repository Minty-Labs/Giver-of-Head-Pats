...
public static class Vars {
    ...
    public const string Version = "1.0.0" + (IsDebug ? "-dev" : ""); // Major.Feature.Minor
    public static readonly DateTime BuildTime = IsDebug ? DateTime.UtcNow : new DateTime(2024, 2, 3, 14, 13, 00);
