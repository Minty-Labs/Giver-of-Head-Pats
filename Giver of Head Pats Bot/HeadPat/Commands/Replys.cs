...
public class ReplyApplication : ApplicationCommandModule {
    [SlashCommand("AddReply", "Adds an auto response for the server", false)]
    ...
    [SlashCommand("RemoveReply", "Removes a trigger response by the provided trigger", false)]
    [SlashRequireUserPermissions(Permissions.ManageMessages)]
    ...
    [SlashCommand("ListTriggers", "Lists the triggers for auto responses")]
