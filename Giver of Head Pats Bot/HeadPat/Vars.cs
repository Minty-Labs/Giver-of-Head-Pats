...
public static class Vars {
    public const string DSharpVer = "5.0.0-nightly-01815";
...
#else
    public const string Version = "2023.10.1" + (IsDebug ? "-dev" : ""); // Year.Month.Revision
    public static readonly DateTime BuildTime = IsDebug ? DateTime.Now : new(2023, 10, 5, 19, 26, 00); // (year, month, day, hour, min, sec)
