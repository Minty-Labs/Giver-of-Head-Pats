...
#else
    public const string Version = "2023.9.6" + (IsDebug ? "-dev" : ""); // Year.Month.Revision
    public static readonly DateTime BuildTime = IsDebug ? DateTime.Now : new(2023, 9, 28, 18, 53, 00); // (year, month, day, hour, min, sec)
