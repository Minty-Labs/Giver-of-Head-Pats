...
public static class Vars {
    ...
    public const string Version = "5.3.0" + (IsDebug ? "-dev" : ""); // Major.Feature.Minor
    public static readonly DateTime BuildTime = IsDebug ? DateTime.UtcNow : new DateTime(2024, 4, 18, 16, 38, 00);
