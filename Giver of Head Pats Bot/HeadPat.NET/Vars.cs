...
public static class Vars {
    ...
    private static readonly Version VersionObj = new (5, 3, 10); // Major.Feature.Minor
    ...
    // public static string? BuildTime => Assembly.GetExecutingAssembly().GetCustomAttribute<AssemblyMetadataAttribute>()?.Value!;
    ...
    public static readonly string TargetDotNetVersion = "9.0.3";
}