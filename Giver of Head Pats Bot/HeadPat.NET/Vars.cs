...
public static class Vars {
    ...
    public const string Version = "5.0.4" + (IsDebug ? "-dev" : ""); // Year.Month.Revision
    public static readonly DateTime BuildTime = IsDebug ? DateTime.UtcNow: new(2023, 12, 6, 16, 36, 00); // (year, month, day, hour, min, sec)
