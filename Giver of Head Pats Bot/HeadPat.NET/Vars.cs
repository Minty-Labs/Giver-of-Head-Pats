...
public static class Vars {
    ...
    public const string Version = "5.0.3" + (IsDebug ? "-dev" : ""); // Year.Month.Revision
    public static readonly DateTime BuildTime = IsDebug ? DateTime.UtcNow: new(2023, 12, 5, 15, 53, 00); // (year, month, day, hour, min, sec)
